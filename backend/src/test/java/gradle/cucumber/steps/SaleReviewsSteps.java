...
public class SaleReviewsSteps {
    ...
    public void iLeaveAStarReviewWithTheComment(int arg0, String arg1) {
    ...
    public void anErrorMessageIsReturnedToSayThatNoStarRatingHasBeenProvidedForTheReview() {
